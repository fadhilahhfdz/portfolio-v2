...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto p-6 flex flex-row flex-wrap-reverse justify-between mt-12">
        <div className="max-w-xl">
          ...
          {/* tombol */}
          <a href="https://wa.me/6281234982153" target="_blank">
        ...
        <div>
          <img
            ...
            alt="profil"
            width={250}
            className="rounded-full shadow-[0_0_100px_4px] shadow-violet-800 mx-14"
